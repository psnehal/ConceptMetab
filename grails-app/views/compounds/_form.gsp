...
<div class="fieldcontain ${hasErrors(bean: compoundsInstance, field: 'compSrc', 'error')} ">
	...
	<g:select name="compSrc" from="${conceptmetab.Compound_sources.list()}" multiple="multiple" optionKey="id" size="5" value="${compoundsInstance?.compSrc*.id}" class="many-to-many"/>
</div>
