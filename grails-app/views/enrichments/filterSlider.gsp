...
<div  style="width: 30%; float:right ;  border:1px solid">
		...
		<g:set var="fil" value="${params.fil}"/>	
			...
			<span class="property-value" aria-labelledby="original_id-label">	<g:link controller="Enrichments" action="createJson" params="[id1:id1,id2:id2,q:q,fil:fil ]">Click here for complete network</g:link></span>
				...
				<div id="tabpanel">	
				 ...
				 <div id="tabs-2">
				 		<table  align="center">
								...
								<tr><td>"GOBP"</td>
								    <td><div class="circle_gobp"></div>	</td>		
								</tr>
								<tr><td> "GOCC"</td>
								    <td><div class="circle_gocc"></div></td>		
								</tr>
								<tr><td> "GOMF"</td>
								    <td><div class="circle_gomf"></div></td>		
								</tr>
								<tr><td>"Enzyme"</td>
								   <td><div class="circle_enzyme"></div></td>		
								</tr>
								<tr><td>"KEGG"</td>
								    <td><div class="circle_kegg"></div></td>		
								</tr>
								<tr><td>  "MeSH"</td>
								    <td ><div class="circle_mesh"></div></td>		
								</tr>
								<tr><td>"Cluster"</td>
								    <td><div class="circle_cluster"></div></td>		
								</tr>
							</table>
